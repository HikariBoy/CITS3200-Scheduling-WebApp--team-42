...
function openUnavailabilityModal(date) {
    ...
    // Hide full-day toggle if there are scheduled sessions (can't be unavailable full day if you have sessions)
    if (hasAutoGenerated && fullDayContainer) {
        fullDayContainer.style.display = 'none';
    } else if (fullDayContainer) {
